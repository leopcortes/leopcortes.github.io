...
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.inicio-informacoes', { origin: 'left', delay: 200 });
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.cta-inicio', { origin: 'right', delay: 400 });

ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.sobremim-grid', { origin: 'bottom', delay: 500 });
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.sobremim-informacoes', { origin: 'bottom', delay: 500 });

ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.caixa-conhecimentos', { origin: 'top', delay: 150 });
...
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.contatos-info', { origin: 'left', delay: 300 });
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.contatos-form', { origin: 'right', delay: 300 });
...
/* Projeto Cofre Automático */

ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.projetocofreautomatico-informacoes', { origin: 'bottom', delay: 200 });
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.projetocofreautomatico-imagem', { origin: 'top', delay: 400  });

/* Projeto Calculadora Avançada */

ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.projetocalculadoraavancada-informacoes', { origin: 'bottom', delay: 200 });
ScrollReveal({ duration: 2500, distance: "150px"}).reveal('.projetocalculadoraavancada-imagem', { origin: 'top', delay: 400  });
